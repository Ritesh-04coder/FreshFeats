...
/// Implements Contemporary Spatial Minimalism with Warm Neutral Foundation colors.
class AppTheme {
  AppTheme._();

  // Primary color palette based on design specifications
  static const Color primaryLight =
      Color(0xFFFF6B35); // Energetic orange for CTAs
  static const Color primaryVariantLight =
      Color(0xFFE55A2B); // Darker orange variant
  static const Color secondaryLight =
      Color(0xFF2C3E50); // Deep blue-gray for navigation
  static const Color secondaryVariantLight =
      Color(0xFF1A252F); // Darker blue-gray variant
  ...
  static const Color successLight =
      Color(0xFF10B981); // Fresh green for confirmations
  static const Color warningLight =
      Color(0xFFF59E0B); // Amber for time-sensitive alerts
  static const Color accentLight =
      Color(0xFF8B5CF6); // Sophisticated purple for ratings
  ...
  // Dark theme colors
  static const Color primaryDark = Color(0xFFFF6B35); // Same energetic orange
  static const Color primaryVariantDark = Color(0xFFE55A2B);
  static const Color secondaryDark =
      Color(0xFF3A4A5C); // Lighter blue-gray for dark mode
  ...
  static const Color shadowLight =
      Color(0x0A000000); // Subtle elevation shadows
  ...
  /// Light theme optimized for food delivery app with Contemporary Spatial Minimalism
  static ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      elevation: 1.0, // Subtle elevation per design standards
    ...
    cardTheme: CardTheme(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(12.0), // Generous spacing
      ),
  ...
  /// Dark theme with same design principles adapted for dark mode
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles for restaurant names and important content
      ...
      // Body styles for menu descriptions and main content
